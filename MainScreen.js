        ...
        <ImageBackground source={require('./images/app-background.jpg')} style={styles.image}>
          <Content>
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Detect, understand, and combat dark patterns.</Text>
            </View>
            <View style={styles.category_button_container}>
              <TouchableOpacity
                style={styles.category_button}
                onPress={() => this.props.navigation.navigate('Dictionary', {currentUser: this.currentUser})}>
                <View style={styles.category_icon}>
                  <Image 
                    source={require('./icons/icons8-book-30.png')}
                    />  
                </View>
              ...
              <TouchableOpacity
                style={styles.category_button}
                onPress={() => this.props.navigation.navigate('Quiz', {currentUser: this.currentUser})}>
                <View style={styles.category_icon}>
                  <Image
                    source={require('./icons/icons8-questions-30.png')}
                  />
                </View>
                <View style={styles.category_text}>
