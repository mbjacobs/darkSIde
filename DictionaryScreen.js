        ...
        <ImageBackground
          ...
          <Content>
            <View>
              ...
              <View style={[styles.cardCounter, styles.button]}>
                <Text style={styles.buttonText}>
                  Card: {this.state.cardNumber} / {this.state.darkPatterns.length}
                </Text>
              </View>
              <Card
                ...
                definition={
                  this.state.darkPatterns[this.state.cardIndex].description
                }></Card>
              <View style={styles.navigation}>
                <Entypo
                  ...
                  size={36}
                  color="white"
                  onPress={this.rewindDeck}
                />
                <TouchableOpacity
                  style={[styles.button, styles.shuffle]}
                  onPress={this.shuffleCard}>
